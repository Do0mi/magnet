...
exports.getWishlist = async (req, res) => {
  try {
    ...
    res.status(500).json({ status: 'error', message: 'Failed to get wishlist' });
  }
};
...
exports.addToWishlist = async (req, res) => {
  try {
    ...
    await wishlist.save();
    res.status(200).json({ status: 'success', message: 'Product added to wishlist', data: { wishlist: wishlist.products } });
  } catch (err) {
...
exports.removeFromWishlist = async (req, res) => {
  try {
    ...
    await wishlist.save();
    res.status(200).json({ status: 'success', message: 'Product removed from wishlist', data: { wishlist: wishlist.products } });
  } catch (err) {
